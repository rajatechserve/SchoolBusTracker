...
export default function Drivers(){
  ...
  useEffect(()=>{ load(); },[]);
  const save=async()=>{ try{ if(form.id) await api.put('/drivers/'+form.id, form); else await api.post('/drivers', form); setForm({name:'',phone:'',license:''}); load(); }catch(e){alert('Error');} };
